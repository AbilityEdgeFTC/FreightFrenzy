...
//        );
//
//        WiggleInterpolator interp = new WiggleInterpolator(1,2,new TangentInterpolator(1));
//        PathSegment segment = new PathSegment(line, interp);
//
//        Trajectory traj = new TrajectoryBuilder(new Pose2d(0,0,0), false, velConstraint, accelConstraint)
//                .lineTo(new Vector2d(56, 24))
//                .build();
//
//        MotionProfile profile = traj.getProfile();
//
//        Path path = new Path(segment);
//
//        drive.followTrajectory(new Trajectory(path, profile));
//
//
//
//        switch (placeFreightIn)
