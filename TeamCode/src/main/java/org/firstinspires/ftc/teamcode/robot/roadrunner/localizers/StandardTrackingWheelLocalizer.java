...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 10.43; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 0.63; // in; offset of the lateral wheel
