...
public class SampleTankDrive extends TankDrive {
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftFront = hardwareMap.get(DcMotorEx.class, "mE");
        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, "mE");
        DcMotorEx rightRear = hardwareMap.get(DcMotorEx.class, "mE");
        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, "mE");
