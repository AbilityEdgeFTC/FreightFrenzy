...
public class ElevatorMotion {
    ...
    public static double TICKS_PER_REV = 384.5 * SPOOL_RADIUS;
    ...
    public static PIDCoefficients PID = new PIDCoefficients(.05, 0, 0);

    public static double MAX_VEL = 20; // in/s
    public static double MAX_ACCEL = 10; // in/s^2
    public static double MAX_JERK = 5; // in/s^3
    ...
    public ElevatorMotion(HardwareMap hardwareMap) {
    ...
    public void setHeight(double height) {
        height = Math.min(Math.max(0, height), HUB_LEVEL1);
