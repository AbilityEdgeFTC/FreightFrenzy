...
public class SpinnerFirstPID {
    ...
    public static int LEFT_AUTO_ANGLE_RED = 110;
    public static int LEFT_AUTO_ANGLE_BLUE = -110;
    public static int DUCK_ANGLE_RED = -147;
    public static int DUCK_ANGLE_BLUE = 147;
