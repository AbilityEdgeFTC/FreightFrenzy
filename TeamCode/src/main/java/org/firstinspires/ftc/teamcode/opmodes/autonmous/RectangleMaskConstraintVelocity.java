...
public class RectangleMaskConstraintVelocity implements TrajectoryVelocityConstraint {
    double minX, minY, maxX, maxY;
    TrajectoryVelocityConstraint maxVelocity;

    public RectangleMaskConstraintVelocity(double minX, double minY, double maxX, double maxY, TrajectoryVelocityConstraint maxVelocity) {
        this.minX = minX;
        this.minY = minY;
        this.maxX = maxX;
        this.maxY = maxY;
