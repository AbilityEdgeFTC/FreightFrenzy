 ...
 */
@Config
@Autonomous(name = "Right Red NEW", group = "red")
public class AutoRightRedNew extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        collect = drive.trajectorySequenceBuilder(placement.end())
                .back(5)
    ...
    void goToMin() throws InterruptedException
    {
        if(opModeIsActive())
        {
            threadAuto.setElevatorState(ElevatorState.MIN);
            sleep(800);
    ...
    void goToMid() throws InterruptedException
    {
        if(opModeIsActive())
        {
            threadAuto.setElevatorState(ElevatorState.MID);
            sleep(800);
            dip.releaseFreightPos();
            sleep(1000);
            dip.releaseFreight();
    ...
    void goToMax() throws InterruptedException
    {
        if(opModeIsActive())
        {
            threadAuto.setElevatorState(ElevatorState.MAX);
            sleep(800);
            dip.releaseFreightPos();
            sleep(1000);
            dip.releaseFreight();
